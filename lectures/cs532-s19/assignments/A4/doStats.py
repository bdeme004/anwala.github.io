...
parser = argparse.ArgumentParser(description='''Calculate stats on collected data''')
parser.add_argument('source', metavar='S', nargs='?', default='data',
                    help='folder with .txt files containing data')
parser.add_argument('-g', '--graph', action='store_true', help='plot graphs for collected data')
...
def printStats(data):
    print(data["graph"]["id"] + "- core:")
    print("\t" + str(data["values"].index(data["self"]["y"])) + "/" + str(len(data["values"])))
    print("\t" + "mean: " + str(data["mean"]))
    print("\t" + "standard deviation: " + str(data["stdev"]))
    print("\t" + "median: " + str(data["median"]))

    print("\n" + data["graph"]["id"] + "- two-dev:")
    print("\t" + str(data["twoDevValues"].index(data["self"]["y"])) + "/" + str(len(data["twoDevValues"])))
    print("\t" + "mean: " + str(data["twoDevMean"]))
    print("\t" + "standard deviation: " + str(data["twoDevStdev"]))
    print("\t" + "median: " + str(data["twoDevMedian"]))


with open(input_folder + "/facebook.txt") as inf:
    for line in inf:
...
with open(input_folder + "/linkedin.txt") as inf:
    for line in inf:
        split_line = line.split(',')
...
with open(input_folder + "/tw_follows.txt") as inf:
    for line in inf:
        split_line = line.split(',')
...
with open(input_folder + "/tw_friends.txt") as inf:
    for line in inf:
        split_line = line.split(',')
